...
flags.DEFINE_string("dataset", "chest256_conditional", "The name of dataset [celebA, mnist, lsun]")
flags.DEFINE_string("input_fname_pattern", "*.jpg", "Glob pattern of filename of input images [*]")
flags.DEFINE_string("checkpoint_dir", "checkpoint", "Directory name to save the checkpoints [checkpoint]")
flags.DEFINE_string("sample_dir", "samples_conditional_fm", "Directory name to save the image samples [samples]")
...
def main(_):
  ...
  with tf.Session() as sess:
    ...
    elif FLAGS.dataset == 'chest256_conditional':
      dcgan = DCGAN(
          sess,
          input_width=FLAGS.input_width,
          input_height=FLAGS.input_height,
